...
bool Sample::Frame()
{
	...
	D3DXMATRIX pe;
	D3DXMatrixIdentity(&m_ConstantData.toProj);
	m_ConstantData.toProj._11 = 2.0f / g_rtClient.right;
	m_ConstantData.toProj._31 = -1.0f;
	m_ConstantData.toProj._22 = -2.0f / g_rtClient.bottom;
	m_ConstantData.toProj._32 = 1.0f;

	D3DXMatrixTranspose(&m_ConstantData.toProj, &m_ConstantData.toProj);
#ifdef GPU
	//gpu update
...
HRESULT	Sample::CreateVertexBuffer()
{
	...
	m_vertexList[0].x = 0.0f,	m_vertexList[0].y = 0.0f,	m_vertexList[0].z = 0.5f;
	m_vertexList[1].x = 200.0f,	m_vertexList[1].y = 0.0f,	m_vertexList[1].z = 0.5f;
	m_vertexList[2].x = 0.0f,	m_vertexList[2].y = 200.0f,	m_vertexList[2].z = 0.5f;
	m_vertexList[3].x = 200.0f,	m_vertexList[3].y = 200.0f,	m_vertexList[3].z = 0.5f;
