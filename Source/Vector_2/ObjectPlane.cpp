...
{
	m_VertexList[0].p = Vector3(0.0f, 0.0f, 0.0f);
	m_VertexList[0].c = Vector4(1.0f, 0.0f, 0.0f, 1.0f);

	m_VertexList[1].p = Vector3(0.0f, 1.0f, 0.0f);
	m_VertexList[1].c = Vector4(0.0f, 1.0f, 0.0f, 1.0f);

	m_VertexList[3].p = Vector3(1.0f, 0.0f, 0.0f);
	m_VertexList[3].c = Vector4(0.0f, 0.0f, 1.0f, 1.0f);

	Vector3 vDir0 = m_VertexList[1].p - m_VertexList[0].p;
	Vector3 vDir1 = m_VertexList[3].p - m_VertexList[0].p;
	m_VertexList[2].p = (vDir0 + vDir1).Normal();
	m_VertexList[2].c = Vector4(1.0f, 0.0f, 1.0f, 1.0f);

	m_VertexList[5].p = (-vDir0 * 1.0f).Normal();;
	m_VertexList[5].c = Vector4(0.0f, 1.0f, 1.0f, 1.0f);
	m_VertexList[6].p = ((vDir0 + vDir1) * -1.0f).Normal();
	m_VertexList[6].c = Vector4(1.0f, 1.0f, 0.0f, 1.0f);
	m_VertexList[7].p = (-vDir1 * 1.0f).Normal();
	m_VertexList[7].c = Vector4(1.0f, 1.0f, 1.0f, 1.0f);

	vDir0 = m_VertexList[3].p - m_VertexList[0].p;
	vDir1 = m_VertexList[5].p - m_VertexList[0].p;
	m_VertexList[4].p = (vDir0 + vDir1).Normal();
	m_VertexList[4].c = Vector4(1.0f, 0.0f, 1.0f, 1.0f);

	m_VertexList[8].p = ((vDir0 + vDir1) * -1.0f).Normal();
	m_VertexList[8].c = Vector4(1.0f, 1.0f, 0.0f, 1.0f);

	//m_VertexList =
	//{
	//	m_VertexList[0] = {Vector3(0.0f, 0.0f ,0.0f), Vector4(1.0f, 0.0f, 0.0f, 1.0f)},
	//	m_VertexList[1] = {Vector3(0.0f, 1.0f ,0.0f), Vector4(0.0f, 1.0f, 0.0f, 1.0f)},
	//	m_VertexList[2] = {(vDir0 + vDir1).Normalize(), Vector4(0.0f, 0.0f, 1.0f, 1.0f)},
	//	m_VertexList[3] = {Vector3(1.0f, 0.0f ,0.0f), Vector4(1.0f, 1.0f, 1.0f, 1.0f)},

	//	m_VertexList[4] = {, Vector4(1.0f, 0.0f, 0.0f, 1.0f)},
	//	m_VertexList[5] = {(-vDir0).Normalize() ,			Vector4(0.0f, 1.0f, 0.0f, 1.0f)},
	//	m_VertexList[6] = {-((vDir0 + vDir1).Normalize()) , Vector4(0.0f, 1.0f, 0.0f, 1.0f)},
	//	m_VertexList[6] = {-(vDir1).Normalize() , Vector4(0.0f, 1.0f, 0.0f, 1.0f)},
	//};
...
{
	pContext->UpdateSubresource(m_DxObject.m_pConstantBuffer, 0, nullptr, &m_cbData, 0, 0);
